...
- Script 82 ejecutado y verificado (22/07/2026). Pendiente antes de poder usarlo de punta a punta: (1) completar `mail.smtp.user`/`mail.smtp.password` (cuenta remitente + clave de aplicacion) en `config/sdrerc-app.properties` o via variables de entorno; (2) probar un login real con un usuario que tenga `correo` cargado.
