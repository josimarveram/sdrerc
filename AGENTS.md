...
- `Analisis`: cuando el resultado sea `NO_CORRESPONDE`, bloquear `Acta incorporada`, evaluaciones, documentos analizados, observacion y comentario de movimiento; exigir motivo y numero de proveido, y registrar el proveido como `EXPEDIENTE_DOCUMENTO` dentro de la misma transaccion; no exigir ni registrar documentos analizados para esta ruta.
