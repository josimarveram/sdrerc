...
- `Analisis`: cuando el resultado sea `NO_CORRESPONDE`, bloquear `Acta incorporada` y las evaluaciones, exigir motivo y numero de proveido, y registrar el proveido como `EXPEDIENTE_DOCUMENTO` dentro de la misma transaccion; no exigir documentos analizados para esta ruta.
