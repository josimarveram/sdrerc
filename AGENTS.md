...
- `Asignacion`: en asignacion multiple, la hoja de envio se captura por expediente y se persiste en `EXPEDIENTE_ASIGNACION.NUMERO_HOJA_ENVIO`; el numero debe ser unico antes de confirmar la asignacion.
