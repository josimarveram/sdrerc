...
- En la bandeja de Registro / Recepcion, los filtros visibles deben priorizar busqueda, rango de `Fecha solicitud` y cantidad a mostrar; no mostrar filtros de etapa ni estado. Esta bandeja debe consultar solo expedientes `REGISTRO / REGISTRADO`.
