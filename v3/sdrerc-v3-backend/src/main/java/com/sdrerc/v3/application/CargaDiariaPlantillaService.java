...
/**
 * Port casi literal de com.sdrerc.application.sdrercapp.CargaDiariaPlantillaService (V2): misma
 * plantilla Excel (hoja CARGA_DIARIA con listas desplegables + validaciones, hoja CATALOGOS oculta,
 * hoja INSTRUCCIONES), mismos catálogos/validaciones. Único cambio real: escribe a un
 * {@link ByteArrayOutputStream} (para servir por HTTP) en vez de un {@link java.io.File} (V2 usaba
 * {@code JFileChooser}).
 */
@Service
public class CargaDiariaPlantillaService {
    ...
    private void crearHojaInstrucciones(Workbook workbook, CellStyle titleStyle, CellStyle textStyle) {
        ...
        String[] instrucciones = {
            ...
            "Despues de completar el archivo, subalo desde la pantalla Carga diaria en Registro / Recepcion."
        };
