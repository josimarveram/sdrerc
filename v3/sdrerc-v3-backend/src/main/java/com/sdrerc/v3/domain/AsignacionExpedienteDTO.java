...
/**
 * Port casi literal de com.sdrerc.domain.dto.sdrercapp.AsignacionExpedienteDTO (V2), mismos
 * campos y misma lógica derivada (isAsignable/getAlertaIngreso/etc. — se reutilizan tal cual
 * para que el frontend no tenga que reimplementar estas reglas). Sin cambios de comportamiento.
 */
