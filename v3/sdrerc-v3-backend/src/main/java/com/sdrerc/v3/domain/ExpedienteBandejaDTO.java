...
/**
 * Port de com.sdrerc.domain.dto.sdrercapp.ExpedienteBandejaDTO (V2). V2 tiene 3 constructores
 * sobrecargados (compatibilidad histórica); aquí solo se porta el constructor completo, que es el
 * único que usa {@code ExpedienteBandejaDAO.map(...)} realmente.
 */
public class ExpedienteBandejaDTO {
    ...
    public ExpedienteBandejaDTO(
            ...
            Long diasRestantes,
            boolean grupoFamiliarConfirmado) {
