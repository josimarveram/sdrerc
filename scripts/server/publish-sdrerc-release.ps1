...
Write-Host ""
Write-Host "Publicacion LAN/UNC esperada:"
Write-Host "  Compartir D:\\SDRERC_RELEASES como recurso SMB"
Write-Host "  Exponer la carpeta latest por UNC, por ejemplo:"
Write-Host "  \\\\SERVIDOR\\SDRERC_RELEASES\\latest"
Write-Host ""
Write-Host "Archivos esperados en latest:"
Write-Host "  version.json"
Write-Host "  SDRERC-V2.zip"
