...
PROMPT Agregando numero de hoja de envio a EXPEDIENTE_ASIGNACION...
...
BEGIN
  ...
  IF v_count = 0 THEN
    EXECUTE IMMEDIATE
      ...
      'CASE WHEN numero_hoja_envio IS NOT NULL AND activo = 1 THEN UPPER(TRIM(numero_hoja_envio)) END' ||
      ')';
  END IF;
END;
/

PROMPT Validacion de columna e indice:
