 ...
 * @author betom
 */
public class JPanelListadoExpedientesNotificacionPorTrabajar extends javax.swing.JPanel {
     ...
     */
    public JPanelListadoExpedientesNotificacionPorTrabajar() {
        initComponents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2 && jTable1.getSelectedRow() != -1)
        {
            ...
            if (fila >= 0)
            {
                ...
                JPanelRegistrarExpedientesNotificacionPorTrabajar panel = new JPanelRegistrarExpedientesNotificacionPorTrabajar();
                try
                {
