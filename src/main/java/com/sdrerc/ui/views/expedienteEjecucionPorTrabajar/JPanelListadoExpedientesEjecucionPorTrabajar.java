 ...
 * @author betom
 */
public class JPanelListadoExpedientesEjecucionPorTrabajar extends javax.swing.JPanel implements Scrollable {
    ...
    public JPanelListadoExpedientesEjecucionPorTrabajar() {
        ...
        cargarComboEstados();
        configurarListadoEjecucionPorTrabajarPremium();
        buscarExpedientes();
    }
    ...
    private void cargarMapaCatalogo(int idCatalogo, Map<Integer, String> destino)
    {
      ...
      private void buscarExpedientes() 
      {
        try 
        {
            ...
            List<Expediente> lista = expedienteEjecucionPorTrabajarService.ListarExpedientesEjecucionPorTrabajar(88);
            ...
            mostrarMensajeListado(filtrada.isEmpty() ? "No se encontraron expedientes de ejecución por trabajar con los filtros seleccionados." : " ");
        } 
        catch (Exception e) {
            cargarTablaNueva(java.util.Collections.<Expediente>emptyList());
            mostrarMensajeListado("No se pudo cargar el listado de expedientes de ejecución por trabajar.");
        }
      }
    ...
    {
        DefaultTableModel model = crearModeloTablaExpedientesEjecucionPorTrabajar();
        model.setRowCount(0);
        ...
        configurarTablaExpedientesEjecucionPorTrabajar();
    }

    private DefaultTableModel crearModeloTablaExpedientesEjecucionPorTrabajar()
    {
        String[] columnas = {
    ...
    private void configurarListadoEjecucionPorTrabajarPremium()
    {
    ...
    private JButton crearBotonExportarExcel()
    {
        ...
        button.addActionListener(e -> exportarListadoExpedientesEjecucionPorTrabajarExcel());
        return button;
    }

    private void exportarListadoExpedientesEjecucionPorTrabajarExcel()
    {
        ...
        fileChooser.setSelectedFile(new File(nombreArchivoExcelExpedientesEjecucionPorTrabajar()));
        ...
        try {
            escribirExcelExpedientesEjecucionPorTrabajar(archivo, filasExportacion);
            JOptionPane.showMessageDialog(this, "Archivo Excel generado correctamente.");
        } catch (IOException ex) {
            Logger.getLogger(JPanelListadoExpedientesEjecucionPorTrabajar.class.getName()).log(Level.WARNING, "No se pudo exportar listado de Bandeja de ejecución", ex);
            JOptionPane.showMessageDialog(this, "No se pudo exportar el archivo Excel.");
        }
    }

    private String nombreArchivoExcelExpedientesEjecucionPorTrabajar()
    {
    ...
    private void escribirExcelExpedientesEjecucionPorTrabajar(File archivo, List<Integer> filasExportacion) throws IOException
    {
    ...
    private JPanel crearCardResultados()
    {
        ...
        superior.add(crearPanelFiltrosPorColumnaExpedientesEjecucionPorTrabajar(), BorderLayout.CENTER);
    ...
    private JPanel crearPanelFiltrosPorColumnaExpedientesEjecucionPorTrabajar()
    {
        configurarFiltrosPorColumnaExpedientesEjecucionPorTrabajar();
    ...
    private void configurarFiltrosPorColumnaExpedientesEjecucionPorTrabajar()
    {
    ...
    private void configurarTablaExpedientesEjecucionPorTrabajar()
    {
        ...
        jTable1.setDefaultRenderer(Object.class, new ExpedienteEjecucionPorTrabajarCellRenderer());
        configurarRendererPlazoAtencion();
        configurarOrdenamientoTablaExpedientesEjecucionPorTrabajar();
    ...
    private void configurarOrdenamientoTablaExpedientesEjecucionPorTrabajar()
    {
    ...
    private int obtenerIdTecnicoFiltroEjecucionPorTrabajar()
    {
    ...
    private class ExpedienteEjecucionPorTrabajarCellRenderer extends DefaultTableCellRenderer {
        @Override
        public Component getTableCellRendererComponent(
       ...
       if (evt.getClickCount() == 1 && columna >= 0 && jTable1.convertColumnIndexToModel(columna) == COL_EXPANDIR)
       {
        ...
        if (evt.getClickCount() == 2 && jTable1.getSelectedRow() != -1)
        {
            ...
            if (fila >= 0)
            {
                ...
                {
                    Logger.getLogger(JPanelListadoExpedientesEjecucionPorTrabajar.class.getName()).log(Level.SEVERE, null, ex);
                }
