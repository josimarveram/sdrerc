...
public class JPanelAsignacionV2 extends JPanel {
    ...
    private static final Color[] FOCUS_ACCENTS = new Color[]{
        ...
        new Color(30, 59, 97),
        new Color(251, 196, 165),
        new Color(239, 104, 77),
        new Color(223, 141, 149),
        new Color(180, 127, 142),
        new Color(111, 107, 120),
        new Color(63, 95, 135),
        new Color(147, 186, 210),
        new Color(11, 120, 145),
        new Color(11, 142, 143),
        new Color(10, 169, 143),
        new Color(17, 194, 161),
        new Color(13, 28, 56),
        new Color(100, 117, 126),
        new Color(44, 58, 46),
        new Color(87, 195, 195),
        new Color(110, 160, 222),
        new Color(146, 120, 221)
    };
    private static final Color[] FOCUS_BACKGROUNDS = new Color[]{
        new Color(252, 235, 237),
        new Color(230, 240, 245),
        new Color(229, 235, 242),
        new Color(255, 240, 231),
        new Color(253, 234, 228),
        new Color(249, 232, 235),
        new Color(243, 232, 236),
        new Color(239, 238, 243),
        new Color(231, 238, 246),
        new Color(234, 243, 248),
        new Color(225, 244, 248),
        new Color(225, 245, 244),
        new Color(223, 245, 240),
        new Color(221, 248, 241),
        new Color(232, 237, 245),
        new Color(232, 238, 240),
        new Color(229, 236, 230),
        new Color(226, 246, 246),
