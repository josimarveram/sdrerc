...
public class JPanelBandejaExpedientesNueva extends JPanel {
    ...
    private final class JPanelRegistrarGrupoFamiliarV2 extends AppV2SideActionPanel {
        ...
        private JPanelRegistrarGrupoFamiliarV2() {
            ...
            panelTablaIntegrantes.getScrollPane().setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_NEVER);
        ...
        private void cargarPosiblesIntegrantes(ExpedienteBandejaDTO expedientePrincipal) {
            ...
            SwingWorker<List<GrupoFamiliarCandidatoDTO>, Void> worker =
                ...
                protected void done() {
                    ...
                    ajustarAlturaGrillaSinScrollVertical(tablaIntegrantes, panelTablaIntegrantes.getScrollPane());
                    actualizarBotonAsociarGrupoFamiliar();
                }
            };
            worker.execute();
        ...
        private void cargarGrupoActual(Long idExpediente) {
            ...
            SwingWorker<List<GrupoFamiliarIntegranteDTO>, Void> worker =
                ...
                protected void done() {
                    ...
                    ajustarAlturaGrillaSinScrollVertical(tablaGrupoActual, panelTablaGrupoActual.getScrollPane());
                }
            };
            worker.execute();
        }
