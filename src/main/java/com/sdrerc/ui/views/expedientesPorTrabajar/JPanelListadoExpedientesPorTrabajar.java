...
public class JPanelListadoExpedientesPorTrabajar extends javax.swing.JPanel implements Scrollable {
    ...
    {
        DefaultTableModel model = crearModeloTablaExpedientesPorTrabajar();
        model.setRowCount(0);
    ...
    private DefaultTableModel crearModeloTablaExpedientesPorTrabajar()
    {
        String[] columnas = {
    ...
    private JButton crearBotonExportarExcel()
    {
        ...
        button.addActionListener(e -> exportarListadoExpedientesPorTrabajarExcel());
        return button;
    }

    private void exportarListadoExpedientesPorTrabajarExcel()
    {
        ...
        fileChooser.setSelectedFile(new File(nombreArchivoExcelExpedientesPorTrabajar()));
        ...
        try {
            escribirExcelExpedientesPorTrabajar(archivo, filasExportacion);
            JOptionPane.showMessageDialog(this, "Archivo Excel generado correctamente.");
        } catch (IOException ex) {
            Logger.getLogger(JPanelListadoExpedientesPorTrabajar.class.getName()).log(Level.WARNING, "No se pudo exportar listado de expedientes por trabajar", ex);
            JOptionPane.showMessageDialog(this, "No se pudo exportar el archivo Excel.");
        }
    }

    private String nombreArchivoExcelExpedientesPorTrabajar()
    {
        String timestamp = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"));
        return "expedientes_por_trabajar_" + timestamp + ".xlsx";
    }
    ...
    private void escribirExcelExpedientesPorTrabajar(File archivo, List<Integer> filasExportacion) throws IOException
    {
    ...
    private JPanel crearCardResultados()
    {
        ...
        superior.add(crearPanelFiltrosPorColumnaExpedientesPorTrabajar(), BorderLayout.CENTER);
    ...
    private JPanel crearPanelFiltrosPorColumnaExpedientesPorTrabajar()
    {
        configurarFiltrosPorColumnaExpedientesPorTrabajar();
    ...
    private void configurarFiltrosPorColumnaExpedientesPorTrabajar()
    {
    ...
    private void configurarTablaExpedientesPorTrabajar()
    {
        ...
        configurarOrdenamientoTablaExpedientesPorTrabajar();
    ...
    private void configurarOrdenamientoTablaExpedientesPorTrabajar()
    {
       ...
       if (evt.getClickCount() == 1 && columna >= 0 && jTable1.convertColumnIndexToModel(columna) == COL_EXPANDIR)
       {
        ...
        if (evt.getClickCount() == 2 && jTable1.getSelectedRow() != -1)
        {
            ...
            if (fila >= 0)
            {
                ...
                {
                    Logger.getLogger(JPanelListadoExpedientesPorTrabajar.class.getName()).log(Level.SEVERE, null, ex);
                }
